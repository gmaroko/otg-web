define(['scroller', 'dom', 'layoutManager', 'inputManager', 'focusManager', 'browser', 'registerElement', 'css!./otg-scroller'], function (scroller, dom, layoutManager, inputManager, focusManager, browser) {
    'use strict';

    var ScrollerPrototype = Object.create(HTMLDivElement.prototype);

    ScrollerPrototype.createdCallback = function () {
        this.classList.add('otg-scroller');
    };
    ...
    function loadScrollButtons(scroller) {
        require(['otg-scrollbuttons'], function () {
            scroller.insertAdjacentHTML('beforebegin', '<div is="otg-scrollbuttons" class="otg-scrollbuttons padded-right"></div>');
        });
    }
    ...
    document.registerElement('otg-scroller', {
