define(["loading", "dialogHelper", "dom", "jQuery", "components/libraryoptionseditor/libraryoptionseditor", "otg-toggle", "otg-input", "otg-select", "paper-icon-button-light", "listViewStyle", "formDialogStyle", "otg-button", "flexStyles"], function(loading, dialogHelper, dom, $, libraryoptionseditor) {
    "use strict";
