define(['layoutManager', 'globalize', 'require', 'events', 'browser', 'alphaPicker', 'otg-input', 'flexStyles', 'material-icons', 'css!./searchfields'], function (layoutManager, globalize, require, events, browser, AlphaPicker) {
    'use strict';
