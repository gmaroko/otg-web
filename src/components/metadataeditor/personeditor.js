define(['dialogHelper', 'layoutManager', 'globalize', 'require', 'paper-icon-button-light', 'otg-input', 'otg-select', 'css!./../formdialog'], function (dialogHelper, layoutManager, globalize, require) {
    'use strict';
