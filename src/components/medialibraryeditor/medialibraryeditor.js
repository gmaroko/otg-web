define(["jQuery", "loading", "dialogHelper", "dom", "components/libraryoptionseditor/libraryoptionseditor", "otg-button", "listViewStyle", "paper-icon-button-light", "formDialogStyle", "otg-toggle", "flexStyles"], function(jQuery, loading, dialogHelper, dom, libraryoptionseditor) {
    "use strict";
