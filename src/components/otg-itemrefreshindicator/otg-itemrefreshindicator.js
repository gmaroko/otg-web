define(['otg-progressring', 'dom', 'serverNotifications', 'events', 'registerElement'], function (EmbyProgressRing, dom, serverNotifications, events) {
    'use strict';
    ...
    document.registerElement('otg-itemrefreshindicator', {
