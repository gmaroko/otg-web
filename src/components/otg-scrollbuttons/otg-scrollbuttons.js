define(['layoutManager', 'dom', 'css!./otg-scrollbuttons', 'registerElement', 'paper-icon-button-light'], function (layoutManager, dom) {
    'use strict';
    ...
    function getScrollButtonHtml(direction) {
        ...
        html += '<button type="button" is="paper-icon-button-light" data-ripple="false" data-direction="' + direction + '" class="otg-scrollbuttons-button">';
    ...
    EmbyScrollButtonsPrototype.attachedCallback = function () {
        ...
        parent.classList.add('otg-scroller-container');

        this.innerHTML = getScrollButtonHtml('left') + getScrollButtonHtml('right');

        var buttons = this.querySelectorAll('.otg-scrollbuttons-button');
    ...
    document.registerElement('otg-scrollbuttons', {
