define(['dom', 'scroller', 'browser', 'layoutManager', 'focusManager', 'registerElement', 'css!./otg-tabs', 'scrollStyles'], function (dom, scroller, browser, layoutManager, focusManager) {
    'use strict';

    var EmbyTabs = Object.create(HTMLDivElement.prototype);
    var buttonClass = 'otg-tab-button';
    ...
    function initScroller(tabs) {
        ...
        var contentScrollSlider = tabs.querySelector('.otg-tabs-slider');
    ...
    EmbyTabs.createdCallback = function () {
        ...
        if (this.classList.contains('otg-tabs')) {
            return;
        }
        this.classList.add('otg-tabs');
    ...
    EmbyTabs.setTabEnabled = function (index, enabled) {
        ...
        var tabs = this;
        var btn = this.querySelector('.otg-tab-button[data-index="' + index + '"]');
    ...
    document.registerElement('otg-tabs', {
        prototype: EmbyTabs,
        extends: 'div'
    });
});