        ...
        switch (result.State) {
            ...
            case 'ServerUpdateNeeded':
                require(['alert'], function (alert) {
                    alert({
                        text: globalize.translate('ServerUpdateNeeded', 'https://github.com/gmaroko/otg'),
                        html: globalize.translate('ServerUpdateNeeded', '<a href="https://github.com/gmaroko/otg">https://github.com/gmaroko/otg</a>')
                    }).then(function () {
                        appRouter.showSelectServer();
                    });
                });
