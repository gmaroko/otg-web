define(["appSettings", "loading", "browser", "otg-button"], function(appSettings, loading, browser) {
    "use strict";
    ...
    function handleConnectionResult(page, result) {
        ...
        switch (result.State) {
            ...
            case "ServerUpdateNeeded":
                Dashboard.alert({
                    message: Globalize.translate("ServerUpdateNeeded", '<a href="https://github.com/otg/otg">https://github.com/otg/otg</a>')
                });
                break;
            case "Unavailable":
                Dashboard.alert({
