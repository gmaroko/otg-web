define(["layoutManager", "loading", "cardBuilder", "apphost", "imageLoader", "scripts/livetvcomponents", "listViewStyle", "otg-itemscontainer"], function (layoutManager, loading, cardBuilder, appHost, imageLoader) {
    "use strict";
