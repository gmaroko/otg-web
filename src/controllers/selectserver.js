            ...
            connectionManager.connectToServer(server, {
                ...
                switch (result.State) {
                    ...
                    case "ServerUpdateNeeded":
                        alertTextWithOptions({
                            text: globalize.translate("core#ServerUpdateNeeded", "https://github.com/gmaroko/otg"),
                            html: globalize.translate("core#ServerUpdateNeeded", '<a href="https://github.com/gmaroko/otg">https://github.com/gmaroko/otg</a>')
                        });
                        break;
